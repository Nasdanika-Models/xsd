package org.nasdanika.models.xsd.ecore.tests;
...
import org.nasdanika.models.xsd.ecore.EcoreGenXsdProcessorsFactory;
 ...
 *
 */
public class TestXsdModelDocGen {
	
	@Test
	public void testGenerateXsdModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenXsdProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenXsdProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "xsd.xmi");
		...
		String siteMapDomain = "https://xsd.models.nasdanika.org";		
